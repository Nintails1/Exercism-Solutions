"""Meltdown Mitigation - Functions to prevent a nuclear meltdown."""
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentage_power_efficiency = generated_power / theoretical_max_power * 100
    if percentage_power_efficiency >= 80:
        return 'green'
    elif percentage_power_efficiency >= 60:
        return 'orange'
    elif percentage_power_efficiency >= 30:
        return 'red'
    else:
        return 'black'
