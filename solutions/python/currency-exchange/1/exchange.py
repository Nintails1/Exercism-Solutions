"""Currency Exchange - Functions for calculating steps in exchanging currency."""
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    foreign_amount = int(budget / actual_rate)
    return (foreign_amount // denomination) * denomination 
